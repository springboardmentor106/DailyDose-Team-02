...
import login from "../assets/images/register copy.png";
  ...
  return (
    ...
    <div className="form-wrapper">
      <form className="login_box">
        ...
        <div className="input_box">
          <input type="password" id="cpass" className="input-field" required />
          <label for="cpass" className="label">
            Confirm Password
          </label>
          <i className="bx bxs-lock-alt icon"></i>
        </div>
    ...
    <div className="img-wrapper" style={{backgroundColor: "rgba(255,255,255,0.25)"}}>
      <div className="img-box">
        <img src={login} alt="login main" />
        <img src={bg_img} alt="login background" style={{backgroundColor: "#0C1320"}}/>
      </div>
    </div>
  </div>
  )
