                ...
                <div className="home-col-one">
                  <div className="home-row-one">
                    <div className="card">
                      <div className="card-body">
                        <div>
                          <CircularProgressBar value={unassign.walk} />
                        </div>
                        <div id="dis">
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div>
                          <CircularProgressBar value={unassign.exercise} />
                        </div>
                        <div id="dis">
                          <strong>1 hour walk</strong>
                        </div>
                  ...
                  <div className="home-row-one">
                    <div className="card">
                      <div className="card-body">
                        <div>
                          <CircularProgressBar value={unassign.meditation} />
                        </div>
                        <div id="dis">
                          <strong>1 hour walk</strong>
                        </div>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div>
                          <CircularProgressBar value={unassign.sleep} />
                        </div>
                        <div id="dis">
                          <strong>1 hour walk</strong>
                        </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <p>&#8226; Manageing medical care</p>{" "}
                        <p>&#8226; Advocating the User needs</p>
                        <br />{" "}
                        <p>
                          If you have any questions about your responsibilities
                          as a caretaker,Please contact the User.Thank you for
                          your willingness to be a caretaker!
                        </p>
                      </div>
