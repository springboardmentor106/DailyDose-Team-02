    ...
    <h2 className="accordion-header">
      ...
      <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
        ...
        <div className="ass-user-detail">
            <div><strong>{assignedUser.name}</strong></div>
            <div><p>{assignedUser.phno}</p></div>
      ...
      <div className="home-col-one">
          <div className="home-row-one">
            <div className="card"><div className="card-body">
              <div><CircularProgressBar value={assignedUser.walk}/></div>  
              <div id="dis"><strong>1 hour walk</strong></div>
            </div></div>
            <div className="card"><div className="card-body">
              <div><CircularProgressBar value={assignedUser.exercise}/></div>  
          ...
          <div className="home-row-one">
            ...
            <div className="card"><div className="card-body">
              ...
              <div id="dis"><strong>Sleeping</strong></div>  
            </div></div>
          </div>
        </div>
